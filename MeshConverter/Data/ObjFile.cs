...
namespace MeshConverter.Data
{
    ...
    public class ObjFile
    {
        ...
        public Image Preview(int width, int height, PreviewDirection direction, bool zUp = false)
        {
            ...
            float scale2dY;// = innerHeight / (zUp ? lengthZ : lengthY);
            ...
            switch (direction)
            {
                ...
                case PreviewDirection.Front:
                    ...
                    scale2dY = innerHeight / (zUp ? lengthZ : lengthY);
                    break;
                case PreviewDirection.Left:
                    scale2dX = innerWidth / (zUp ? lengthY : lengthZ);
                    scale2dY = innerHeight / (zUp ? lengthZ : lengthY);
                    break;
                ...
                case PreviewDirection.Top:
                    scale2dX = innerWidth / lengthX;
                    scale2dY = innerHeight / (zUp ? lengthY : lengthZ);
                    break;
            }
            ...
            switch (direction)
            {
                ...
                case PreviewDirection.Front:
                    ...
                    offset2dY = (int)(innerHeight - (zUp ? pixelLengthZ : pixelLengthY)) / 2;
                    break;
                case PreviewDirection.Left:
                    offset2dX = (int)(innerWidth - (zUp ? pixelLengthY : pixelLengthZ)) / 2;
                    offset2dY = (int)(innerHeight - (zUp ? pixelLengthZ : pixelLengthY)) / 2;
                    break;
                case PreviewDirection.Right:
                    offset2dX = (int)(innerWidth - (zUp ? pixelLengthY : pixelLengthZ)) / 2;
                ...
                case PreviewDirection.Top:
                    offset2dX = (int)(innerWidth - pixelLengthX) / 2;
                    offset2dY = (int)(innerHeight - (zUp ? pixelLengthY : pixelLengthZ)) / 2;
                    break;
            }
                    ...
                    try
                    {
                        ...
                        switch (direction)
                        {
                            ...
                            case PreviewDirection.Front:
                                ...
                                y1 = border + innerHeight - offset2dY - (int)((zUp ? (offset3dZ + v1.Z) : (offset3dY + v1.Y)) * scale);
                                y2 = border + innerHeight - offset2dY - (int)((zUp ? (offset3dZ + v2.Z) : (offset3dY + v2.Y)) * scale);
                                break;
                            case PreviewDirection.Left:
                                x1 = border + offset2dX + (int)((zUp ? (offset3dY + v1.Y) : (offset3dZ + v1.Z)) * scale);
                                x2 = border + offset2dX + (int)((zUp ? (offset3dY + v2.Y) : (offset3dZ + v2.Z)) * scale);

                                y1 = border + innerHeight - offset2dY - (int)((zUp ? (offset3dZ + v1.Z) : (offset3dY + v1.Y)) * scale);
                                y2 = border + innerHeight - offset2dY - (int)((zUp ? (offset3dZ + v2.Z) : (offset3dY + v2.Y)) * scale);
                                break;
                            case PreviewDirection.Right:
                                x1 = border + innerHeight - offset2dX - (int)((zUp ? (offset3dY + v1.Y) : (offset3dZ + v1.Z)) * scale);
                                x2 = border + innerHeight - offset2dX - (int)((zUp ? (offset3dY + v2.Y) : (offset3dZ + v2.Z)) * scale);
                            ...
                            case PreviewDirection.Top:
                                ...
                                y1 = border + innerHeight - offset2dY - (int)((zUp ? (offset3dY + v1.Y) : (offset3dZ + v1.Z)) * scale);
                                y2 = border + innerHeight - offset2dY - (int)((zUp ? (offset3dY + v2.Y) : (offset3dZ + v2.Z)) * scale);
                                break;
                        }
        ...
        public Bitmap GetMultiAnglePreviewImage(int width = 128, int height = 128, bool zUp = false)
        {
            int previewW = width / 2;
            int previewH = height / 2;

            Bitmap bmp = new Bitmap(width, height);

            Image previewLeft = this.Preview(previewW, previewH, ObjFile.PreviewDirection.Left, zUp);
            Image previewFront = this.Preview(previewW, previewH, ObjFile.PreviewDirection.Front, zUp);
            Image previewRight = this.Preview(previewW, previewH, ObjFile.PreviewDirection.Right, zUp);
            Image previewTop = this.Preview(previewW, previewH, ObjFile.PreviewDirection.Top, zUp);

            Graphics g = Graphics.FromImage(bmp);
            g.DrawImage(previewLeft, new Point(0, 0));
            g.DrawImage(previewFront, new Point(previewW, 0));
            g.DrawImage(previewRight, new Point(0, previewH));
            g.DrawImage(previewTop, new Point(previewW, previewH));
